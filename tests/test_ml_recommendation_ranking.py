    ...
    candidates = [
        {
            "id": "python-1",
            "model_score": 0.99,
            "metadata": {"title": "Senior Python Engineer", "skills": "python, fastapi"},
        },
        {
            "id": "python-2",
            "model_score": 0.98,
            "metadata": {"title": "Python API Engineer", "skills": "python, fastapi"},
        },
        {
            "id": "data-1",
            "model_score": 0.90,
            "metadata": {"title": "Data Engineer", "skills": "sql, airflow"},
        },
        {
            "id": "frontend-1",
            "model_score": 0.30,
            "metadata": {"title": "Frontend Engineer", "skills": "react, typescript"},
        },
    ]
