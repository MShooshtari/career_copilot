...
# Market analysis: cohort = SQL filters intersect top-k by profile embedding
MARKET_ANALYSIS_DEFAULT_POSTED_WITHIN_DAYS = 90
MARKET_ANALYSIS_DEFAULT_COHORT_LIMIT = 500
MARKET_ANALYSIS_FALLBACK_COHORT_LIMIT = 300  # when user has no profile embedding
MARKET_ANALYSIS_CHUNK_MAX_CHARS = 1_200
MARKET_ANALYSIS_CHUNK_OVERLAP_CHARS = 150
MARKET_ANALYSIS_RAG_TOP_CHUNKS = 18
MARKET_ANALYSIS_TOP_SKILLS_CHART = 10
MARKET_ANALYSIS_TOP_LOCATIONS = 12
