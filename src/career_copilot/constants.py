...
RECOMMENDATIONS_DIVERSITY_SIMILARITY_PENALTY = 0.18
RECOMMENDATIONS_DIVERSITY_CATEGORY_PENALTY = 0.04
RECOMMENDATIONS_EXPLORATION_RATE = 0.20
RECOMMENDATIONS_CACHE_TTL_SECONDS = 5 * 60
...
MARKET_ANALYSIS_REPORT_CACHE_TTL_SECONDS = 15 * 60
MARKET_ANALYSIS_RAG_EMBEDDING_CACHE_TTL_SECONDS = 30 * 60
MARKET_ANALYSIS_CHUNK_MAX_CHARS = 1_200
MARKET_ANALYSIS_CHUNK_OVERLAP_CHARS = 150
MARKET_ANALYSIS_RAG_TOP_CHUNKS = 12
